...
const HomeProducts = ({products,categories,genders,cartTotal,noOfCart,cartRef,cartButtonRef,clrTotal,clrCartNum,bitch}) => {
	...
	// PASSING TOTAL AND CARTNUM as PROPS
	// const propsHandle = () => {
	// 	cartTotal(total);
	// 	noOfCart(cartNum);
	// }
	useEffect(() => {
		...
		localStorage.setItem("noOfCart",cartNum);
	},[total,cartNum])
